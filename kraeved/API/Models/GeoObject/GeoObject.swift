...
struct GeoObject: Codable, Equatable, Hashable {
	...
	//        type = try values.decode(GeoObjectTypeDto.self, forKey: .type)
	...
	init(id: Int? = nil,
			 ...
			 longitude: Double = 0,
			 latitude: Double = 0,
			 type: GeoObjectTypeDto = .init(id: 0, name: "", title: "", categoryId: 0),
			 images: [String] = [],
			 thumbnail: String = ""
	) {
		self.id = id
...
struct GeoObjectTypeDto: Decodable, Hashable, Equatable {
	var id: Int
	var name: String
	var title: String
	var categoryId: Int
	var category: GeoObjectCategoryDto?
}

struct GeoObjectCategoryDto: Decodable, Hashable, Equatable {
	var id: Int
	var name: String
	var title: String
}
